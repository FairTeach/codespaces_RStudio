...
[![Open in GitHub Codespaces](figures/badge.svg)](https://codespaces.new/FairTeach/codespaces_RStudio?quickstart=1)

**Continue GitHub Codespaces practical on the cloud!**
[![Continue GitHub Codespaces](figures/GitHub-Codespaces-181717.svg)](https://github.com/codespaces)
...
> **Lesson ** Transcript Differential Usage using Bioconductor and R  
...
```{bash }
# Run in terminal Needed to install IsoformSwitchAnalyzeR
# sudo apt-get update
...
knitr::opts_knit$set(root.dir = "/workspaces/codespaces_RStudio/practicals")
# Install and load packages
# if (!requireNamespace("BiocManager", quietly = TRUE)){
#     install.packages("BiocManager")
#     BiocManager::install()
# }
# BiocManager::install(c("DEXSeq", "BSgenome", "rtracklayer", "tximeta"))
...
# directory <- "C:/Users/WINDOWS.ADMON-CFNAVARRA/OneDrive - NAVARRA SOCIEDADES PÚBLICAS/Others/classes/Unav2023/DTU"


# Set your working directory once per session
getwd()
directory <- "/workspaces/codespaces_RStudio/practicals" 
setwd(directory)
...
# Download .RData
Rdata <-  drive_get(as_id("1iViTjOCvhEJ7yyI6NsY5k8smi2O5DYwn"))
drive_download(Rdata, overwrite = TRUE,  path="DTU_download2.RData")

# Download GTF
# https://drive.google.com/file/d/14lvKCVXRG8qwwileT1vnDYhDUFiT6BIo/view?usp=drive_link
gtf <-  drive_get(as_id("14lvKCVXRG8qwwileT1vnDYhDUFiT6BIo"))
drive_download(gtf, overwrite = TRUE,  path="gencode.v33.primary_assembly.annotation.gtf")

# Download fasta trasnscripts
# https://drive.google.com/file/d/1KWYpaCIxhwRq-0DhQTaQDQFU-_kBBHA3/view?usp=drive_link
TranscrIsoforms <-  drive_get(as_id("1KWYpaCIxhwRq-0DhQTaQDQFU-_kBBHA3"))
drive_download(TranscrIsoforms, overwrite = TRUE,  path="isoformSwitchAnalyzeR_isoform_nt.fa")


# load a workspace into the current session
# if you don't specify the path, the cwd is assumed
load("DTU_download2.RData") 
...
### Create switchAnalyzeRlist      This process is quite computational intensive, so I already provided you the aSwitchList object to load
# aSwitchList <- importRdata(
#   isoformCountMatrix   = salmonQuant$counts,
#   isoformRepExpression = salmonQuant$abundance,
#   designMatrix         = myDesign,
#   isoformExonAnnoation = "/workspaces/codespaces_RStudio/practicals/gencode.v33.primary_assembly.annotation.gtf",
#   isoformNtFasta       = "/workspaces/codespaces_RStudio/practicals/isoformSwitchAnalyzeR_isoform_nt.fa",
